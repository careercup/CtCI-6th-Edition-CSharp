...
namespace Ch_16._Moderate.Q16_20_T9
{
	// 最佳化
	// Trie
    public class Q16_20_T9B : Question
    {
		...
		public static IList<string> GetValidT9WordsB(string number, Trie trie)
		{
		...
		public static void GetValidWords(string number, int index, string prefix, TrieNode trieNode, IList<string> results)
		{
        ...
        {
			IList<string> words = GetValidT9WordsB("8733", AssortedMethods.GetTrieDictionary());
