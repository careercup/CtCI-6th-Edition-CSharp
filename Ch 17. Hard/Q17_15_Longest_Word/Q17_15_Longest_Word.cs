...
{
    public class Q17_15_Longest_Word : Question
    {
		public static string PrintLongestWord(string[] arr)
		{
			...
			Array.Sort(arr, new LengthComparator()); // Sort by length
		...
		public static bool CanBuildWord(string str, bool isOriginalWord, IDictionary<string, bool> map)
		{
